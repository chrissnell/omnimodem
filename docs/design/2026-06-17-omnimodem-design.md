...
- **Phase-1 plan.** The plan matches the reorganized Phase 1 above (stub core,
  locked contracts, the met exit criterion) and needs no structural change; its
  one "batteries toolkit" wording was updated to "building blocks" in this change.
  The design's Phase headings are kept verbatim so the plan's cross-references
  stay valid.
