...
/**
 * RX audio pump: captures PCM16 mono from the MIC source (a USB audio dongle
 * routes to MIC when present) and feeds it into the Rust modem via
 * ModemBridge.modemPushSamples on a dedicated high-priority thread.
 */
class AudioPump {
